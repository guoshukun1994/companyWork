  ...
  <div class="consume">
    ...
    <div class="table">
      <el-table :data="tableData" :header-cell-style="tableHeaderColor">
        <el-table-column :index="indexMethod" align="right" label="序号" type="index"></el-table-column>
    ...
    <div>
      <el-dialog v-dialogDrag    :visible.sync="consumeDialagVisible" title="更多" width="1380px" top="0">
        <ConsumeTable @getDetail="jumpDetail" :comp_CD="comp_CD" />
      </el-dialog>
    </div>
    <div>
      <el-dialog :visible.sync="detailVisible" title="详情" width="1380px" top="0">
