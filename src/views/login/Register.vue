<template>
    ...
    >
      ...
      <div class="title">企业信息</div>
        ...
        >
            <el-form
                ...
                label-width="100px"
            >
                <!-- <el-form-item style="width:77%;height:40px" class="conpInfo">
        <div>
          <div class="title" style="margin-top:20px">企业信息</div>
        </div>
      </el-form-item>
      <el-form-item prop="compCD" label="企业编码:">
        ...
        />
        <div
          style="width:200px;height:1px;background:rgba(153,153,153,0.5)"
        ></div>
      </el-form-item>
      ...
      <el-form-item prop="contPhone" label="联系人电话:">
        ...
        ></div>
                ...
                <el-form-item style="width: 100%; height: 50px;" class="conpInfo">
                    <div>
                        <!-- <img
              src="../../assets/user.png"
            ...
            /> -->
                ...
                <el-form-item prop="userCd" label="用户账号:">
                    ...
                    <div style="width:200px;height:1px;background:rgba(153,153,153,0.5)"></div>
                </el-form-item>
                ...
                <el-button
                    ...
                    :disabled="disabled"
                    type="primary"
                    style="width: 120px; height: 40px; margin-right: 190px; margin-top: 2px;"
                >
