...
export function searchBox(data, token) {
    return request({
        url: '/api/searchBox',
        method: 'post',
        headers: {
...
export function searchSecondary(data, token) {
    return request({
        url: '/api/searchSecondary',
        method: 'post',
        headers: {
            Authorization: 'Bearer ' + token
        },
...
export function checkForgetPsw(data) {
    return request({
        url: '/api/checkForgetPsw',
        method: 'post',
        data
    });
}
export function modifySmsPsw(data) {
    return request({
        url: '/api/modifySmsPsw',
        method: 'post',
        data
    });
}
...
export function compRegister(data, token) {
    return request({
        url: '/api/compRegister',
        method: 'post',
        headers: {
            Authorization: 'Bearer ' + token
        },
...
export function compDetailsNotRegistered(data, token) {
    return request({
        url: '/api/compDetailsNotRegistered',
        method: 'post',
        headers: {
            Authorization: 'Bearer ' + token
        },
...
export function batchTransfer(data, token) {
    return request({
...
export function delHistoryBindingBar(data, token) {
    return request({
        url: '/api/delHistoryBindingBar',
        method: 'post',
        headers: {
            Authorization: 'Bearer ' + token
        },
...
export function recoverHistoryBar(data, token) {
    return request({
        url: '/api/recoverHistoryBar',
        method: 'post',
        headers: {
            Authorization: 'Bearer ' + token
        },
