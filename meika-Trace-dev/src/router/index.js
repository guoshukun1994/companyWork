    ...
    children: [
      {
        ...
        meta: { title: '标签直接生成', icon: 'add', roles: ['2', '1', '0'] }
      },
      {
        path: 'tagsbind',
        name: 'TagsBind',
        component: () => import('@/views/tags/TagsBind'),
        meta: { title: '商品标签绑定', icon: 'bind', roles: ['2', '1', '0'] }
      }, {
        path: 'tagspro',
        name: 'TagsPro',
        component: () => import('@/views/tags/index'),
        meta: { title: '商品标签生成', icon: 'add', roles: ['2', '1', '0'] }
      },
      {
        path: 'codemanagement',
        name: 'CodeManagement',
        component: () => import('@/views/code/index'),
        meta: { title: '历史标签查询', icon: 'search', roles: ['2', '1', '0'] }
      }
    ]
  }, {
    path: '/goods',
    ...
    children: [
      {
        ...
        meta: { title: '商品信息维护', icon: 'setting', roles: ['2', '1', '0'] }
      }
    ...
    children: [
      {
        ...
        meta: { title: '企业信息维护', icon: 'setting', roles: ['2', '1', '0'] }
      },
      {
        path: 'examine',
        name: 'Examine',
    ...
    children: [
      {
        ...
        name: 'Dashboard',
        component: () => import('@/views/dashboard/index'),
        meta: { title: '个人信息中心', icon: 'userInfo', roles: ['2', '1', '0'] }
      },
      {
        path: 'userinfomanagement',
        name: 'UserManagement',
        component: () => import('@/views/userInfo/index'),
        meta: { title: '用户信息维护', icon: 'setting', roles: ['2', '1', '0'] }
      },
    ]
  }, {
    path: '/visualisation',
    ...
    children: [
      {
        ...
        meta: { title: '溯源监控管理', icon: 'see', roles: ['2', '1', '0'] }
      }
    ]
  },
