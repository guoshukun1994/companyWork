<template>
  <div class="tagsBind">
    ...
    >
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item label="企业名称:" v-else>
          <el-input v-model="formInline.compName" style="width:300px" :disabled="true"></el-input>
        </el-form-item>
        ...
        <el-form-item label="标签状态:">
          <el-radio-group v-model="formInline.synInput">
            <el-radio
              v-for="(item, index) in [{key:'1',value:'已同步存证'},{key:'0',value:'未同步存证'}]"
              :key="item.key"
    ...
    >
      ...
      <el-table-column prop="goods_CD" label="商品编码" width="150" align="center"></el-table-column>
      <el-table-column
        prop="goods_Name"
        label="商品名称"
        width="150"
      ...
      >
        <template
          slot-scope="scope"
        >{{ scope.row.reg_hash==0||scope.row.reg_hash=='0'?scope.row.reg_hash='暂无存证':scope.row.reg_hash }}</template>
      </el-table-column>
      <el-table-column
      ...
      <el-table-column prop="comp_CD" label="企业编码" width="100" show-overflow-tooltip align="center"></el-table-column>
      <el-table-column
        prop="comp_Name"
        label="企业名称"
        width="200"
      ...
      <el-table-column
        ...
        align="center"
      ></el-table-column>
      <el-table-column prop="address" label="操作" show-overflow-tooltip align="center" fixed="right">
        <template slot-scope="scope">
          <el-button size="mini" type="danger" @click="handleDeleteOne(scope.$index, scope.row)">删 除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <el-form-item label="企业名称:">
                <el-input v-model="innerVisibleData.compName" style="width:400px" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="商品:">
                <el-input :value="tagBindForm.goodsName" style="width:400px" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="商品规格:">
                <el-input :value="tagBindForm.goods_Spen" style="width:400px" :disabled="true"></el-input>
              </el-form-item>
              ...
              <el-form-item label="商品描述:">
                <el-input :value="tagBindForm.goods_Describe" style="width:400px" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="有效期:">
                <el-input :value="tagBindForm.shelf_life" style="width:400px" :disabled="true"></el-input>
              </el-form-item>
              ...
              <el-form-item label="批次号:">
                <el-input :value="tagBindForm.goods_lot" style="width:400px" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="商品价格:">
                <el-input :value="tagBindForm.goods_pric" style="width:400px" :disabled="true"></el-input>
              </el-form-item>
              ...
              <!-- <el-form-item label="商品编码:">
              <el-input v-model="innerVisibleData.goodsName" style="width:300px" :disabled="true"></el-input>
              </el-form-item>-->
            ...
            <el-table-column label="序号" type="idnex" width="55" align="center">
              <template scope="scope">
                <span>
                  {{
                  scope.$index +
                  (innerVisibleData.pageNum - 1) * innerVisibleData.pageSize +
                  1
                  }}
                </span>
              </template>
            </el-table-column>
            <el-table-column prop="check_code" label="验证码" align="center"></el-table-column>
            <el-table-column
              prop="consume_code"
              label="消费码"
              width="600"
              ...
              align="center"
            ></el-table-column>
            <el-table-column prop="upd_date" label="生成日期" show-overflow-tooltip align="center">
              <template slot-scope="scope">
                {{
          ...
          <div class="block" style="width:95%;margin:0 auto;text-align:center;margin-top:10px">
            <el-pagination
          ...
          <div style="width:95%;margin:0 auto;text-align:center;margin-top:20px">
            ...
            <el-button type="primary" @click="scynDataToGoodsBind">提 交</el-button>
          </div>
        </div>
      </el-dialog>
      <!-- 商品标签绑定界面开始-->
      ...
      >
        ...
        >
          ...
          <el-form-item label="企业名称:" prop="compName" v-if="userType==2" style="width:50%">
          ...
          <el-form-item label="企业名称:" v-else>
            <el-input v-model="tagBindForm.compName" :disabled="true" style="width:300px"></el-input>
          </el-form-item>
          <el-form-item label="商品:" prop="goodsName" v-if="userType==2">
            <el-select
          ...
          <el-form-item label="商品:" prop="goodsName" v-else style="margin-left:60px">
            <el-select
              v-model="tagBindForm.goodsName"
              placeholder="请选择商品"
              @change="getGoodsName"
          ...
          <el-form-item label="商品规格:" prop="goods_Spen">
            <el-input v-model="tagBindForm.goods_Spen" :disabled="true" style="width:300px"></el-input>
          </el-form-item>
          <el-form-item label="商品效期:" prop="goods_shelf_life" style="margin-left:60px">
            <el-input v-model="tagBindForm.goods_shelf_life" :disabled="true" style="width:300px;"></el-input>
          </el-form-item>
          ...
          <el-form-item label="商品价格:" prop="goods_pric">
            <el-input v-model="tagBindForm.goods_pric" style="width:150px" type="number"></el-input>
          </el-form-item>
        ...
        <div style="width:95%;height:1px;background:rgba(200, 200, 200, 0.6);;margin:0 auto"></div>
        <el-form
          :inline="true"
          :model="tagBindForm"
          class="demo-form-inline"
        ...
        >
          ...
          <el-form-item>
            <el-button type="primary" class="tags-button" @click="synLabelsOneInfo">绑定验证码</el-button>
            <el-button
              type="primary"
              class="tags-button"
        ...
        <div v-loading="bindDataLoading" element-loading-spinner="el-icon-loading">
          <el-table
            ref="multipleTable"
            :data="bindData"
            tooltip-effect="dark"
          ...
          >
            ...
            <el-table-column label="序号" width="55" type="index" align="center" fixed="left">
              <template scope="scope">
                <span>{{ (tagsBindTablePageNum- 1) * tagsBindTablePageSize + scope.$index + 1 }}</span>
              </template>
            </el-table-column>
            <!-- <el-table-column
            prop="goods_CD"
        ...
        <div style="width:95%;margin-top:10px;text-align:center">
          ...
          <el-button type="primary" @click="resetForm('tagBindForm')">新 增</el-button>
          <!-- <el-button type="primary" @click="submitForm('tagBindForm')"
            >新 增</el-button
          >-->
        </div>
      </div>
...
export default {
  data() {
    var validateGoods_pric = (rule, value, callback) => {
      var reg = /^\d+(\.\d+)?$/;
      if (!reg.test(value)) {
  ...
  computed: {
    ...
    getPageData() {
      ...
      let start =
        this.tagsBindTablePageSize * this.tagsBindTablePageNum -
        this.tagsBindTablePageSize;
  ...
  methods: {
    ...
    bindTags() {
      Object.keys(this.tagBindForm).forEach(
        key => (this.tagBindForm[key] = "")
      );
      this.innerVisibleData.compName = "";
    ...
    bindTagsInfo() {
      ...
      showAllGoodsName({ compID: this.compID }, this.$store.getters.token).then(
        res => {
    ...
    synLabelsInfo() {
      if (!this.multiOne.length) {
        ...
        synInput(
          { checkCodes: multiOneInfo, source: 1 },
          this.$store.getters.token
        ).then(res => {
            this.homeLoading = false;
          if (res.code == 1) {
    ...
    tableDataHandleCurrentChange(currentRow, oldCurrentRow) {
    ...
    searchLabelsInfo() {
      ...
      searchLabels(this.innerVisibleData, this.$store.getters.token).then(
        res => {
    ...
    getTimeStamp() {
      if (this.timeValueOne != null) {
        this.formInline.relDateStart =
          new Date(this.timeValueOne[0]).getTime() / 1000;
        this.formInline.relDateEnd =
          new Date(this.timeValueOne[1]).getTime() / 1000;
      } else {
        this.formInline.relDateStart = "";
        this.formInline.relDateEnd = "";
      }
