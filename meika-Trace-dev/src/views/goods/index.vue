      ...
      <div class="goods-form">
        ...
        >
          ...
          <el-table-column
            ...
            :show-overflow-tooltip="true"
          />
          <el-table-column label="商品简称" align="center" width="150" prop="goods_Simple_Name" />
          <el-table-column
            label="商品规格"
            align="center"
            width="150"
          ...
          >
            <template
              slot-scope="scope"
            >{{ scope.row.goods_Hash==null||scope.row.goods_Hash=='' ?'暂无存证':scope.row.goods_Hash }}</template>
          </el-table-column>
          <el-table-column
            label="存证时间"
            align="center"
          ...
          >
            <template
              slot-scope="scope"
            >{{ scope.row.goods_Hash_Datetime==null?'暂无存证时间': changeTimestamp(scope.row.goods_Hash_Datetime*1000) }}</template>
          </el-table-column>
          <el-table-column
            label="操作"
            align="center"
          ...
          >
            <template slot-scope="scope">
              <el-button size="mini" type="success" @click="handleEdit(scope.$index, scope.row)">编 辑</el-button>
      ...
      <div class="goods-infoForm" style="margin-top:10px">
        ...
        >
          ...
          >
            <template
              slot-scope="scope"
            >{{ scope.row.photo_Type=='00'?'商品图片':( scope.row.photo_Type=='90'?'其它':'商品说明书') }}</template>
          </el-table-column>
          <el-table-column
            label="文件名"
            align="center"
          ...
          >
            <template
              slot-scope="scope"
            >{{ scope.row.photo_Hash==null?'暂无存证':scope.row.photo_Hash }}</template>
          </el-table-column>
          <el-table-column
            label="存证时间"
            align="center"
        ...
        >
          ...
          >
            <el-form-item v-if="userType=='2'" label="企业编码:" prop="compCD">
              ...
              <el-select v-model="addGoodsForm.compCD" placeholder="请选择企业编码" clearable filterable>
                <el-option
            ...
            <el-form-item label="商品编码:" prop="goodsCD">
              <el-input v-model="addGoodsForm.goodsCD" />
            </el-form-item>
            ...
            <el-form-item style="width:100%" label="商品图片:" prop>
              ...
              >
                <el-button
                  ...
                  type="primary"
                  style="width:610px"
                >上传商品主题图片( png / jpg /jpeg / gif / tiff,限1张,文件大小<=1.5MB)</el-button>
            ...
            <el-form-item style="margin-top:-10px">
              ...
              <el-button type="primary" @click="submitFormOne('addGoodsForm')">提 交</el-button>
            </el-form-item>
          </el-form>
        </el-dialog>
        <!-- 商品新增结束 -->
        ...
        >
          ...
          >
            ...
            <el-form-item style="width:100%" label="商品图片:">
              ...
              >
                <el-button
                  ...
                  type="primary"
                  style="width:620px"
                >上传商品图片( png / jpg / jpeg / gif / tiff,限1张,文件大小<=1.5MB)</el-button>
            ...
            <el-form-item style="width:100%" label="商品说明书:">
              ...
              >
                <el-button
                  ...
                  type="primary"
                  style="width:620px"
                >上传商品说明书( png / jpg / jpeg / gif / tiff,限1张,文件大小<=1.5MB)</el-button>
                <!-- <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过500kb</div> -->
              </el-upload>
            </el-form-item>
            <el-form-item style="width:100%" label="其他图片">
              ...
              >
                <el-button
                  ...
                  type="primary"
                  style="width:620px"
                >上传其他图片( png / jpg / jpeg / gif / tiff,限1张,文件大小<=1.5MB)</el-button>
                <!-- <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过500kb</div> -->
              </el-upload>
            </el-form-item>
            ...
            <el-form-item style="margin-top:-40px">
              ...
              <el-button type="primary" @click="submitFormTwo('addGoodsInfoForm')">提 交</el-button>
            </el-form-item>
          </el-form>
        </el-dialog>
        <el-dialog :visible.sync="dialogVisibleThree" title="商品详情" width="50%" center>
          <el-form
            label-width="100px"
            :inline="true"
            :auto-upload="false"
          ...
          >
            <el-form-item label="商品编码:" prop="goods_CD">
              <el-input :value="goodInfoDetails.goods_CD" :disabled="true" style="width:300px" />
            </el-form-item>
            <el-form-item label="商品存证:" prop="goods_Hash">
              <el-input v-model="goodInfoDetails.goods_Hash" :disabled="true" style="width:300px" />
            </el-form-item>
            <el-form-item label="商品名称:" prop="goods_Name">
              <el-input v-model="goodInfoDetails.goods_Name" :disabled="true" style="width:300px" />
            </el-form-item>
            ...
            <el-form-item label="商品规格:" prop="goods_Spen">
              <el-input v-model="goodInfoDetails.goods_Spen" :disabled="true" style="width:300px" />
            </el-form-item>

            <el-form-item label="保质期:" prop="shelf_life">
              <el-input v-model="goodInfoDetails.shelf_life" :disabled="true" style="width:300px" />
            </el-form-item>
            ...
            <el-form-item label prop="goods_Photo" style="width:100%;height:100%;">
              ...
              <div style="width:400px;height:400px;">
                <img :src="goods_Photo" style="width: 100%;height: 100%;margin:0 auto" />
              </div>
        ...
        <el-dialog title="资料详情" :visible.sync="dialogVisibleFour" width="50%" center>
          <span>
            <div>
              <el-row style="margin-top:10px">
                <el-button @click="toFirst('1')">首 条</el-button>
                <el-button icon="el-icon-arrow-left" @click="toPur('3')">上一条</el-button>
            ...
            >
              <el-form-item label="资料编码:" prop="photo_CD">
                <el-input v-model="infoDialog.photo_CD" :disabled="true" style="width:350px" />
              </el-form-item>
              ...
              <el-form-item label="资料名称:" prop="photo_Name" style="width:100%">
                <el-input v-model="infoDialog.photo_Name" :disabled="true" style="width:795px" />
              </el-form-item>
              <el-form-item label="资料存证:" prop="photo_Hash">
                <el-input
                  :value="infoDialog.photo_Hash==null?'暂未存证':infoDialog.photo_Hash"
                  :disabled="true"
                  style="width:350px"
                />
              </el-form-item>
              <el-form-item label="存证时间:" prop="photo_Hash_Datetime">
                <el-input
                  :value="infoDialog.photo_Hash_Datetime==null?'无存证时间':changeTimestamp(infoDialog.photo_Hash_Datetime*1000)"
                  :disabled="true"
                  style="width:350px"
                />
              </el-form-item>
          ...
          <span>
            ...
            >
              <el-form-item label="企业编码:" prop="comp_CD">
                <el-input v-model="editData.comp_CD" style="width:300px" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="商品编码:" prop="goods_CD">
                <el-input v-model="editData.goods_CD" style="width:300px" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="商品名称:" prop="goods_Name">
                <el-input v-model="editData.goods_Name" style="width:300px"></el-input>
              </el-form-item>
              <el-form-item label="商品简称:" prop="goods_Simple_Name">
                <el-input v-model="editData.goods_Simple_Name" style="width:300px"></el-input>
              </el-form-item>
              <el-form-item label="商品规格:" prop="goods_Spen">
                <el-input v-model="editData.goods_Spen" style="width:300px"></el-input>
              </el-form-item>
              <el-form-item label="保质期:" prop="shelf_life">
                <el-input v-model="editData.shelf_life" style="width:300px"></el-input>
              </el-form-item>
              <el-form-item label="商品描述:" prop="goods_Describe">
                <el-input
              ...
              <el-form-item style="width:100%;margin-top:-10px">
                ...
                <el-button type="primary" @click="submitGoodsInfo('editData')">提 交</el-button>
              </el-form-item>
            </el-form>
          </span>
...
export default {
  data() {
    ...
    return {
      ...
      addGoodsRules: {
        ...
        compCD: [
          { required: true, message: "请选择企业编码", trigger: "blur" }
        ],
        goodsName: [
          { required: true, message: "请输入商品名称", trigger: "blur" },
          {
  ...
  created() {
    allGoods({ pageSize: 5, pageNum: 1 }, this.$store.getters.token).then(
      res => {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      ...
      goodsDetails({ goodsCD: row.goods_CD }, this.$store.getters.token).then(
        res => {
          this.editDataLoading = false;
    ...
    chooseInstanceTwo(val) {
      ...
      // if (val.length > 1) {
      //   this.$refs.goodsInfoData.clearSelection()
      //   this.$refs.goodsInfoData.toggleRowSelection(val.pop())
      // } else if (val.length == 1) {
      //   if (val[0] != undefined) {
      //     this.goodsInfoEnv = val[0].photo_CD
      //   }
      // } else {
      //   this.goodsInfoEnv = ""
      // }
      // this.multipleSelection = val
      // this.goodsInfoEnv = val.photo_CD
    },
    ...
    handleDeleteOne(index, row) {
      this.$confirm("此操作将永久删除该条数据, 是否继续?", "提示", {
        ...
        .then(() => {
          ...
          delGoods({ goodsCD: row.goods_CD }, this.$store.getters.token).then(
            res => {
      ...
      if (this.addGoodsForm.goodsPhoto == "") {
        ...
        this.$refs[formName].validate(valid => {
          if (valid) {
            ...
            formData.append(
              "goodsSimpleName",
              this.addGoodsForm.goodsSimpleName
            );
    ...
    submitFormTwo(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          for (
            let i = 0;
            i < this.addGoodsInfoForm.goodsDataPhoto_goods.length;
            i++
          ) {
            formData.append(
              "goodsDataPhoto_goods",
          ...
          for (
            let m = 0;
            m < this.addGoodsInfoForm.goodsDataPhoto_book.length;
            m++
          ) {
            formData.append(
              "goodsDataPhoto_book",
          ...
          for (
            let k = 0;
            k < this.addGoodsInfoForm.goodsDataPhoto_others.length;
            k++
          ) {
            formData.append(
              "goodsDataPhoto_others",
    ...
    showGoodsDetails(goodsCD) {
      ...
      goodsDetails({ goodsCD: goodsCD }, this.$store.getters.token).then(
        res => {
    ...
    layGoods() {
      let a = "";
      if (this.selectValData.length == 1) {
        ...
        inputGoodsHash(
          {
            goodsCD: this.goodsEnv,
            goods_Name: this.goods_NameEnv,
            goods_Spen: this.goods_SpenEnv,
            goods_Describe: this.goods_DescribeEnv
          },
          this.$store.getters.token
        ).then(res => {
    ...
    showInfoDetails(data) {
      ...
      goodsDataDetails({ photoCD: data }, this.$store.getters.token).then(
        res => {
