<template>
  <div class="examine">
    ...
    <el-form :inline="true" :model="formInline" class="examine-form">
      ...
      <el-form-item label="审核状态:" style="margin-left:20px">
        <el-radio-group v-model="radio">
          <el-radio
            v-for="(item, index) in [{key:'2',value:'待审核'},{key:'0',value:'审核通过'},{key:'9',value:'审核未通过'}]"
            :key="item.key"
    ...
    <div style="width:95%;margin:0 auto;margin-top:10px">
      <el-button type="primary" @click="verBusiness" class="examine-ver" icon="el-icon-star-on">企业审核</el-button>
    </div>
    <el-table
      :data="tableData"
      ref="tableData"
    ...
    >
      ...
      <el-table-column prop="comp_Name" label="企业名称" align="center" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column
        prop="comp_Simp_Name"
        label="企业简称"
        align="center"
      ...
      ></el-table-column>
      <el-table-column prop="comp_Leader" label="企业法人" align="center" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column
        prop="leader_Phone"
        label="法人电话"
        align="center"
        :show-overflow-tooltip="true"
      ></el-table-column>
      <el-table-column prop="comp_Contact" label="联系人" align="center" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="cont_Phone" label="联系人电话" align="center" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column
        prop="comp_Address"
        label="企业地址"
        align="center"
      ...
      <el-table-column prop="add_Date" label="注册时间" align="center" width="180">
        <template
          slot-scope="scope"
        >{{scope.row.add_Date==null?'无注册时间':changeTimestampInfo(scope.row.add_Date*1000) }}</template>
      </el-table-column>
      <el-table-column label="审核状态" align="center" width="80" prop="del_Flag">
        <template
          slot-scope="scope"
        >{{ scope.row.del_Flag==0?'已通过':(scope.row.del_Flag==2?'待审核':'未通过') }}</template>
      </el-table-column>
    </el-table>
    ...
    >
      <span>
        ...
        >
          <el-form-item label="企业编码:">
            <el-input v-model="dialogVisibleData.innerCompCD" style="width:300px" :disabled="true"></el-input>
          </el-form-item>
      ...
      { required: true, message: '请选择审核结果', trigger: 'blur' },
          ...
          >
            <el-radio-group v-model="dialogVisibleData.innerRadio">
              <el-radio
                v-for="(item, index) in [{key:'0',value:'通过'},{key:'9',value:'未通过'}]"
                :key="item.key"
       ...
       { min: 10, max: 200, message: '长度为10到200个字符', trigger: 'blur' }
          ...
          <div style="width:100%;text-align:center">
            ...
            <el-button type="primary" @click="verComp('dialogVisibleData')">提 交</el-button>
          </div>
        </el-form>
      </span>
    </el-dialog>
